...
contract Helper {
    ...
    address constant routerOptimismGoerli = 0xcc5a0B910D9E9504A7561934bed294c51285a78D;
    ...
    address constant routerBaseGoerli = 0x80AF2F44ed0469018922c9F483dc5A909862fdc2;
    ...
    address constant linkBaseGoerli = 0xD886E2286Fd1073df82462ea1822119600Af80b6;
    ...
    // USDC addresses
    address constant usdcOptimismGoerli = 0xe05606174bac4A6364B31bd0eCA4bf4dD368f8C6;
    ...
    address constant usdcBaseGoerli = 0xF175520C52418dfE19C8098071a252da48Cd1C19;
        ...
        returns (address router, address linkToken, address wrappedNative, uint64 chainId)
    {
        if (network == SupportedNetworks.ETHEREUM_SEPOLIA) {
            ...
            return (
                routerOptimismGoerli, linkOptimismGoerli, wethOptimismGoerli, chainIdOptimismGoerli
            );
        } else if (network == SupportedNetworks.ARBITRUM_SEPOLIA) {
            return (
            ...
            return
                (routerAvalancheFuji, linkAvalancheFuji, wavaxAvalancheFuji, chainIdAvalancheFuji);
        } else if (network == SupportedNetworks.POLYGON_MUMBAI) {
            return
                (routerPolygonMumbai, linkPolygonMumbai, wmaticPolygonMumbai, chainIdPolygonMumbai);
        } else if (network == SupportedNetworks.BNB_CHAIN_TESTNET) {
            return (
            ...
            return (routerBaseGoerli, linkBaseGoerli, wethBaseGoerli, chainIdBaseGoerli);
        }
    }
}
